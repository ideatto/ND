...
{
    public sealed class RescueLoanTutorialAdapter : TutorialChapterBehaviour
    {
        private const string LoanPanelOpened = "loan.panel_opened";
        private const string FixedPrincipalLoanIssued = "loan.fixed_principal_issued";

        private static readonly string[] OrderedActions =
        {
            LoanPanelOpened,
            FixedPrincipalLoanIssued
        };
