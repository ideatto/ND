...
public class TradePrepareDraft
{
    ...
    public List<string> selectedWaypointTownIds = new List<string>();
    ...
    public List<TradeItemBundle> selectedSellItems = new List<TradeItemBundle>();
    ...
    public TradePrepareDraft CreateSnapshot()
    {
        var snapshot = new TradePrepareDraft
        {
            ...
            loadedFoodQuantity = loadedFoodQuantity
        };

        if (selectedWaypointTownIds != null)
        {
            snapshot.selectedWaypointTownIds.AddRange(selectedWaypointTownIds);
        }
        ...
        CopyItemSelections(selectedSellItems, snapshot.selectedSellItems);
