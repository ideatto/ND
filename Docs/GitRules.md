...
2. **`main`·`Dev2`에는 절대 직접 push 금지.** 반드시 PR(합치기 요청)로만 반영한다.
...
*관련 문서: `Docs/GitIgnore_Asset_Policy.md`, `Docs/SceneOwners.md`, `Docs/Dependencies.md`*
*최종 수정: 2026-07-08*
